...
def draw(restrict_time, number,jiedian_split_time_work,jiedian_split_time_nonwork):
    ...
    create_dir('./picture' + '/' + str(restrict_time) + ' ' + str(number) + '/' + 'Nosplit')
    create_dir('./picture' + '/' + str(restrict_time) + ' ' + str(number) + '/' + 'splitByregion')
    create_dir('./picture' + '/' + str(restrict_time) + ' ' + str(number) + '/' + 'splitBytime')

    # draw_checi([1209],
    #             [['-', 'dodgerblue']],
    #             restrict_time, number, '1209_checi',550000)
    #
    # draw_cheshu([1209],
    #             [['-', 'dodgerblue'], ['-', 'darkorange']],
    #             restrict_time, number, '1209_cheshu',200000)
    # draw_cheshu_xianyou_zaike_kongshi([1209],
    #             [['-', 'dodgerblue'], ['-', 'darkorange']],
    #             restrict_time, number, '1209_cheshu_zaike_kongshi', 200000)
    # draw_cheshu_region([1209],
    #             [['-', 'dodgerblue'], ['-', 'darkorange']],
    #             restrict_time, number, 'beibu','1209_cheshu_beibu',50000)
    # draw_cheshu_region_xianyou_zaike_kongshi([1209],
    #                    [['-', 'dodgerblue'], ['-', 'darkorange']],
    #                    restrict_time, number, 'beibu', '1209_cheshu_beibu_zaike_kongshi', 50000)
    # draw_cheshu_region([1209],
    #                    [['-', 'dodgerblue'], ['-', 'darkorange']],
    #                    restrict_time, number, 'dongbu', '1209_cheshu_dongbu',50000)
    # draw_cheshu_region_xianyou_zaike_kongshi([1209],
    #                    [['-', 'dodgerblue'], ['-', 'darkorange']],
    #                    restrict_time, number, 'dongbu', '1209_cheshu_dongbu_zaike_kongshi', 50000)
    # draw_cheshu_region([1209],
    #                    [['-', 'dodgerblue'], ['-', 'darkorange']],
    #                    restrict_time, number, 'futianA', '1209_cheshu_futianA',50000)
    # draw_cheshu_region_xianyou_zaike_kongshi([1209],
    #                    [['-', 'dodgerblue'], ['-', 'darkorange']],
    #                    restrict_time, number, 'futianA', '1209_cheshu_futianA_zaike_kongshi', 50000)
    # draw_cheshu_region([1209],
    #                    [['-', 'dodgerblue'], ['-', 'darkorange']],
    #                    restrict_time, number, 'futianB', '1209_cheshu_futianB',50000)
    # draw_cheshu_region_xianyou_zaike_kongshi([1209],
    #                    [['-', 'dodgerblue'], ['-', 'darkorange']],
    #                    restrict_time, number, 'futianB', '1209_cheshu_futianB_zaike_kongshi', 50000)
    # draw_cheshu_region([1209],
    #                    [['-', 'dodgerblue'], ['-', 'darkorange']],
    #                    restrict_time, number, 'luohu', '1209_cheshu_luohu',50000)
    # draw_cheshu_region_xianyou_zaike_kongshi([1209],
    #                    [['-', 'dodgerblue'], ['-', 'darkorange']],
    #                    restrict_time, number, 'luohu', '1209_cheshu_luohu_zaike_kongshi', 50000)
    # draw_cheshu_region([1209],
    #                    [['-', 'dodgerblue'], ['-', 'darkorange']],
    #                    restrict_time, number, 'nanshan', '1209_cheshu_nanshan',50000)
    # draw_cheshu_region_xianyou_zaike_kongshi([1209],
    #                    [['-', 'dodgerblue'], ['-', 'darkorange']],
    #                    restrict_time, number, 'nanshan', '1209_cheshu_nanshan_zaike_kongshi', 50000)
    # draw_cheshu_region([1209],
    #                    [['-', 'dodgerblue'], ['-', 'darkorange']],
    #                    restrict_time, number, 'xibu', '1209_cheshu_xibu',50000)
    # draw_cheshu_region_xianyou_zaike_kongshi([1209],
    #                    [['-', 'dodgerblue'], ['-', 'darkorange']],
    #                    restrict_time, number, 'xibu', '1209_cheshu_xibu_zaike_kongshi', 50000)
    # draw_cheshu_time([1209],
    #                    [['-', 'dodgerblue'], ['-', 'darkorange']],
    #                    restrict_time, number, '1209_cheshu_time',jiedian_split_time_work,jiedian_split_time_nonwork,200000)
    # draw_cheshu_time_xianyou_zaike_kongshi([1209],
    #                  [['-', 'dodgerblue'], ['-', 'darkorange']],
    #                  restrict_time, number, '1209_cheshu_time_zaike_kongshi', jiedian_split_time_work, jiedian_split_time_nonwork,
    #                  200000)
    #
    # draw_zhuangtai(1209,
    #              restrict_time, number, '1209_zhuangtai',200000)
    # draw_zhuangtai_region(1209,
    #                restrict_time, number, 'beibu', '1209_zhuangtai_beibu',50000)
    # draw_zhuangtai_region(1209,
    #                restrict_time, number, 'dongbu', '1209_zhuangtai_dongbu',50000)
    # draw_zhuangtai_region(1209,
    #                restrict_time, number, 'futianA', '1209_zhuangtai_futianA',50000)
    # draw_zhuangtai_region(1209,
    #                restrict_time, number, 'futianB', '1209_zhuangtai_futianB',50000)
    # draw_zhuangtai_region(1209,
    #                restrict_time, number, 'luohu', '1209_zhuangtai_luohu',50000)
    # draw_zhuangtai_region(1209,
    #                restrict_time, number, 'nanshan', '1209_zhuangtai_nanshan',50000)
    # draw_zhuangtai_region(1209,
    #                restrict_time, number, 'xibu', '1209_zhuangtai_xibu',50000)
    # draw_zhuangtai_time(1209,
    #              restrict_time, number, '1209_zhuangtai_time',jiedian_split_time_work,jiedian_split_time_nonwork,200000)



    draw_checi([1211],
                [['--', 'dodgerblue']],
                restrict_time, number, '1211_checi',550000)
    draw_cheshu([1211],
                [['--', 'dodgerblue'], ['--', 'darkorange']],
                restrict_time, number, '1211_cheshu',200000)
    draw_cheshu_xianyou_zaike_kongshi([1211],
                [['--', 'dodgerblue'], ['--', 'darkorange']],
                restrict_time, number, '1211_cheshu_zaike_kongshi', 200000)
    draw_cheshu_region([1211],
                       [['--', 'dodgerblue'], ['--', 'darkorange']],
                       restrict_time, number, 'beibu', '1211_cheshu_beibu',50000)
    draw_cheshu_region_xianyou_zaike_kongshi([1211],
                      [['--', 'dodgerblue'], ['--', 'darkorange']],
                      restrict_time, number, 'beibu', '1211_cheshu_beibu_zaike_kongshi', 50000)
    draw_cheshu_region([1211],
                       [['--', 'dodgerblue'], ['--', 'darkorange']],
                       restrict_time, number, 'dongbu', '1211_cheshu_dongbu',50000)
    draw_cheshu_region_xianyou_zaike_kongshi([1211],
                      [['--', 'dodgerblue'], ['--', 'darkorange']],
                      restrict_time, number, 'dongbu', '1211_cheshu_dongbu_zaike_kongshi', 50000)
    draw_cheshu_region([1211],
                       [['--', 'dodgerblue'], ['--', 'darkorange']],
                       restrict_time, number, 'futianA', '1211_cheshu_futianA',50000)
    draw_cheshu_region_xianyou_zaike_kongshi([1211],
                      [['--', 'dodgerblue'], ['--', 'darkorange']],
                      restrict_time, number, 'futianA', '1211_cheshu_futianA_zaike_kongshi', 50000)
    draw_cheshu_region([1211],
                       [['--', 'dodgerblue'], ['--', 'darkorange']],
                       restrict_time, number, 'futianB', '1211_cheshu_futianB',50000)
    draw_cheshu_region_xianyou_zaike_kongshi([1211],
                      [['--', 'dodgerblue'], ['--', 'darkorange']],
                      restrict_time, number, 'futianB', '1211_cheshu_futianB_zaike_kongshi', 50000)
    draw_cheshu_region([1211],
                       [['--', 'dodgerblue'], ['--', 'darkorange']],
                       restrict_time, number, 'luohu', '1211_cheshu_luohu',50000)
    draw_cheshu_region_xianyou_zaike_kongshi([1211],
                      [['--', 'dodgerblue'], ['--', 'darkorange']],
                      restrict_time, number, 'luohu', '1211_cheshu_luohu_zaike_kongshi', 50000)
    draw_cheshu_region([1211],
                       [['--', 'dodgerblue'], ['--', 'darkorange']],
                       restrict_time, number, 'nanshan', '1211_cheshu_nanshan',50000)
    draw_cheshu_region_xianyou_zaike_kongshi([1211],
                      [['--', 'dodgerblue'], ['--', 'darkorange']],
                      restrict_time, number, 'nanshan', '1211_cheshu_nanshan_zaike_kongshi', 50000)
    draw_cheshu_region([1211],
                       [['--', 'dodgerblue'], ['--', 'darkorange']],
                       restrict_time, number, 'xibu', '1211_cheshu_xibu',50000)
    draw_cheshu_region_xianyou_zaike_kongshi([1211],
                      [['--', 'dodgerblue'], ['--', 'darkorange']],
                      restrict_time, number, 'xibu', '1211_cheshu_xibu_zaike_kongshi', 50000)
    draw_cheshu_time([1211],
                [['--', 'dodgerblue'], ['--', 'darkorange']],
                restrict_time, number, '1211_cheshu_time',jiedian_split_time_work,jiedian_split_time_nonwork,200000)
    draw_cheshu_time_xianyou_zaike_kongshi([1211],
                    [['--', 'dodgerblue'], ['--', 'darkorange']],
                    restrict_time, number, '1211_cheshu_time_zaike_kongshi', jiedian_split_time_work, jiedian_split_time_nonwork,
                    200000)

    draw_zhuangtai(1211,
                   restrict_time, number, '1211_zhuangtai',150000)
    draw_zhuangtai_region(1211,
                          restrict_time, number, 'beibu', '1211_zhuangtai_beibu',40000)
    draw_zhuangtai_region(1211,
                          restrict_time, number, 'dongbu', '1211_zhuangtai_dongbu',40000)
    draw_zhuangtai_region(1211,
                          restrict_time, number, 'futianA', '1211_zhuangtai_futianA',40000)
    draw_zhuangtai_region(1211,
                          restrict_time, number, 'futianB', '1211_zhuangtai_futianB',40000)
    draw_zhuangtai_region(1211,
                          restrict_time, number, 'luohu', '1211_zhuangtai_luohu',40000)
    draw_zhuangtai_region(1211,
                          restrict_time, number, 'nanshan', '1211_zhuangtai_nanshan',40000)
    draw_zhuangtai_region(1211,
                          restrict_time, number, 'xibu', '1211_zhuangtai_xibu',40000)
    draw_zhuangtai_time(1211,
                   restrict_time, number, '1211_zhuangtai_time',jiedian_split_time_work,jiedian_split_time_nonwork,150000)
    ...
    # draw_kongzhi([1209],
    #              [['-', 'dodgerblue'], ['-', 'darkorange']],
    #              restrict_time, number, '1209_kongzhi',1)
    # draw_kongzhi_region([1209],
    #                     [['-', 'dodgerblue'], ['-', 'darkorange']],
    #                     restrict_time, number, 'beibu', '1209_kongzhi_beibu',1)
    # draw_kongzhi_region([1209],
    #                     [['-', 'dodgerblue'], ['-', 'darkorange']],
    #                     restrict_time, number, 'dongbu', '1209_kongzhi_dongbu',1)
    # draw_kongzhi_region([1209],
    #                     [['-', 'dodgerblue'], ['-', 'darkorange']],
    #                     restrict_time, number, 'futianA', '1209_kongzhi_futianA',1)
    # draw_kongzhi_region([1209],
    #                     [['-', 'dodgerblue'], ['-', 'darkorange']],
    #                     restrict_time, number, 'futianB', '1209_kongzhi_futianB',1)
    # draw_kongzhi_region([1209],
    #                     [['-', 'dodgerblue'], ['-', 'darkorange']],
    #                     restrict_time, number, 'luohu', '1209_kongzhi_luohu',1)
    # draw_kongzhi_region([1209],
    #                     [['-', 'dodgerblue'], ['-', 'darkorange']],
    #                     restrict_time, number, 'nanshan', '1209_kongzhi_nanshan',1)
    # draw_kongzhi_region([1209],
    #                     [['-', 'dodgerblue'], ['-', 'darkorange']],
    #                     restrict_time, number, 'xibu', '1209_kongzhi_xibu',1)
    # draw_kongzhi_time([1209],
    #              [['-', 'dodgerblue'], ['-', 'darkorange']],
    #              restrict_time, number, '1209_kongzhi',jiedian_split_time_work,jiedian_split_time_nonwork,1)


    # draw_kongzhi([1211],
    #              [['--', 'dodgerblue'], ['--', 'darkorange']],
    #              restrict_time, number, '1211_kongzhi',1)
    # draw_kongzhi_region([1211],
    #                     [['--', 'dodgerblue'], ['--', 'darkorange']],
    #                     restrict_time, number, 'beibu', '1211_kongzhi_beibu',1)
    # draw_kongzhi_region([1211],
    #                     [['--', 'dodgerblue'], ['--', 'darkorange']],
    #                     restrict_time, number, 'dongbu', '1211_kongzhi_dongbu',1)
    # draw_kongzhi_region([1211],
    #                     [['--', 'dodgerblue'], ['--', 'darkorange']],
    #                     restrict_time, number, 'futianA', '1211_kongzhi_futianA',1)
    # draw_kongzhi_region([1211],
    #                     [['--', 'dodgerblue'], ['--', 'darkorange']],
    #                     restrict_time, number, 'futianB', '1211_kongzhi_futianB',1)
    # draw_kongzhi_region([1211],
    #                     [['--', 'dodgerblue'], ['--', 'darkorange']],
    #                     restrict_time, number, 'luohu', '1211_kongzhi_luohu',1)
    # draw_kongzhi_region([1211],
    #                     [['--', 'dodgerblue'], ['--', 'darkorange']],
    #                     restrict_time, number, 'nanshan', '1211_kongzhi_nanshan',1)
    # draw_kongzhi_region([1211],
    #                     [['--', 'dodgerblue'], ['--', 'darkorange']],
    #                     restrict_time, number, 'xibu', '1211_kongzhi_xibu',1)
    # # draw_kongzhi_time([1211],
    #              [['--', 'dodgerblue'], ['--', 'darkorange']],
    #              restrict_time, number, '1211_kongzhi',jiedian_split_time_work,jiedian_split_time_nonwork,1)
...
def draw_checi(dates,linestyle_color_list,restrict_time,number,save_path,ylimit):
    ...
    for date_index in range(len(dates)):
        ...
        plt.plot(  # 画折线图y
            ...
            label='checi'+'('+str(dates[date_index])+')',
            marker='o',
            markerfacecolor='k'
        )
    ...
    plt.ylabel('the Number of Trips', fontsize=35)
    plt.xlim(0, 24, 1)
    plt.ylim(0, ylimit)
    ...
    # plt.title('非运营车辆时间分布',fontsize=38)
